...
class ProductDetailsData {
  ...
  ProductDetailsData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['wholesale'] != null) {
      wholesale = <Null>[];
      json['wholesale'].forEach((v) {
        //wholesale!.add(new Null.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.wholesale != null) {
      //data['wholesale'] = this.wholesale!.map((v) => v.toJson()).toList();
    }
    data['est_shipping_time'] = this.estShippingTime;
    return data;
  }
}
