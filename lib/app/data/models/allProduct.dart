class AllProductResponse {
  ...
  AllProductResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <AllProductDataList>[];
      json['data'].forEach((v) {
        data!.add(new AllProductDataList.fromJson(v));
      });
    }
...
class AllProductDataList {
  ...
  AllProductDataList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
...
class DetailsLinks {
  ...
  DetailsLinks({this.url, this.label, this.active});
